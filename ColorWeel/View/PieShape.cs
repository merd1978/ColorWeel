...
namespace ColorWeel.View
{
    ...
    public class PieShape : Shape
    {
        ...
        public static readonly RoutedEvent PieShapeSelectedEvent =
            EventManager.RegisterRoutedEvent("PieShapeSelectedEvent", RoutingStrategy.Bubble,
                typeof(RoutedEventHandler), typeof(PieShape));

        public event RoutedEventHandler PieShapeSelected
        {
            add => AddHandler(PieShapeSelectedEvent, value);
            remove => RemoveHandler(PieShapeSelectedEvent, value);
        }
        ...
        protected override void OnMouseLeftButtonDown(MouseButtonEventArgs e)
        {
            ...
            PushOut = 10;
            RaiseEvent(new RoutedEventArgs(PieShapeSelectedEvent));
        }
